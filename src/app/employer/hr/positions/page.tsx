  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
      <div className="mb-6 sm:mb-8 sm:mt-10">
        ...
        <p className="mt-2 text-sm sm:text-base text-gray-600">Бүх албан тушаалуудын жагсаалт</p>
      </div>
            ...
            {!searchTerm && !departmentFilter && (
              <div className="mt-4 sm:mt-6">
                ...
                >
                  ...
                  <span className="hidden sm:inline">Эхний тушаал үүсгэх</span>
                  <span className="sm:hidden">Тушаал үүсгэх</span>
                </Link>
              </div>
            )}
          </div>
